...
{
    /**
     * Allows to center or align the text. Possible values are:<ul><li>left or empty string: left align</li><li>center:
     * center align</li><li>right: right align</li><li>justify: justification (default value when
     * $ishtml=false)</li></ul>
     *
     * @var string
     */
     ...
     * Or a string containing some or all of the following characters (in any order):<ul><li>L: left</li><li>T:
     * top</li><li>R: right</li><li>B: bottom</li></ul>
     *
     * @var mixed
     */
    public $border;
    ...
    public $left;
    /**
     * Indicates where the current position should go after the call.  Possible values are:<ul><li>0: to the right
     * [DEFAULT]</li><li>1: to the beginning of the next line</li><li>2: below</li></ul>
     *
     * @var int
     */
    public $newline;
    ...
    public $styleName;
    /**
     * Stretch carachter mode: <ul><li>0 = disabled (default)</li><li>1 = horizontal scaling only if
     * necessary</li><li>2 = forced horizontal scaling</li><li>3 = character spacing only if necessary</li><li>4 =
     * forced character spacing</li></ul>
     *
     * @var int
     */
    public $stretch;
