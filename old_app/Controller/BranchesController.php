...
class BranchesController extends PageController
{
    ...
    public function __construct()
    {
        ...
        if ($this->surname) {
            ...
            $this->setPageTitle(/* I18N: Branches of a family tree */
    ...
    private function getDescendantsHtml(Individual $individual, Family $parents = null)
    {
        ...
        foreach ($individual->getAllNames() as $name) {
            ...
            if (// one name is a substring of the other
                stripos($surn1, $this->surname) !== false || stripos($this->surname, $surn1) !== false
        ...
        if ($spouse_families) {
            ...
            foreach ($spouse_families as $family) {
                ...
                if ($spouse) {
                    ...
                    if ($marriage_year) {
                        $fam_html .= ' <a href="' . $family->getHtmlUrl() . '" title="' . strip_tags($family->getMarriageDate()
                                                                                                            ->display()) . '"><i class="icon-rings"></i>' . $marriage_year . '</a>';
