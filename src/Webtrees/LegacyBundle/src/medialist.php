        ...
        <table class="list_table">
            <tr>
                ...
                if (WT_USER_CAN_EDIT || WT_USER_CAN_ACCEPT) {
                    ...
                    echo /* I18N: An option in a list-box */
                    I18N::translate('sort by title');
                    echo '</option>';
                    echo '<option value="file" ', ($sortby == 'file') ? 'selected' : '', '>';
                    echo /* I18N: An option in a list-box */
                    I18N::translate('sort by filename');
                    echo '</option>';
                    echo '</select>';
                    echo '</td>';
                } else {
            ...
            <tr>
                <td class="descriptionbox wrap">
                    <?php echo /* I18N: Label for check-box */
            ...
            <tr>
                ...
                <td class="optionbox wrap">
                    <input id="filter" name="filter" value="<?php echo Filter::escapeHtml($filter); ?>" size="14"
                           dir="auto">
                </td>
                <td class="descriptionbox wrap">
        ...
        for ($i = $start, $n = 0; $i < $start + $count; ++$i) {
            ...
            if ($mediaobject->isExternal()) {
                ...
                if ($mediaobject->fileExists()) {
                    ...
                    echo '<p class="ui-state-error">', /* I18N: %s is a filename */
                    I18N::translate('The file “%s” does not exist.', $mediaobject->getFilename()), '</p>';
                }
            }
            echo '<br>';
            echo '<div>';
