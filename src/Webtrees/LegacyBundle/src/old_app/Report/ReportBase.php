 ...
 * @param integer $level  The gedcom line level of the first tag to find, setting level to 0 will cause it to use 1+
 *                        the level of the incoming record
