...
class Date
{
    ...
    static function parseDate($date)
    {
        ...
        switch ($cal) {
            case '@#DGREGORIAN@':
                return new GregorianDate(array(
                                             $y,
                                             $m,
                                             $d
                                         ));
            case '@#DJULIAN@':
                return new JulianDate(array(
                                          $y,
                                          $m,
                                          $d
                                      ));
            case '@#DHEBREW@':
                return new JewishDate(array(
                                          $y,
                                          $m,
                                          $d
                                      ));
            case '@#DHIJRI@':
                return new HijriDate(array(
                                         $y,
                                         $m,
                                         $d
                                     ));
            case '@#DFRENCH R@':
                return new FrenchDate(array(
                                          $y,
                                          $m,
                                          $d
                                      ));
            case '@#DJALALI@':
                return new JalaliDate(array(
                                          $y,
                                          $m,
                                          $d
                                      ));
            case '@#DROMAN@':
                return new RomanDate(array(
                                         $y,
                                         $m,
                                         $d
                                     ));
        ...
        switch ($q1 . $q2) {
            ...
            case 'INT':
                $tmp = /* I18N: Gedcom INT dates */
                    I18N::translate('interpreted %s (%s)', $d1 . $conv1, $this->text);
                break;
            case 'BEF':
