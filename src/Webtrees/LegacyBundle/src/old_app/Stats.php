...
class Stats
{
        ...
        foreach (get_class_methods($this) as $method) {
            ...
            if ($reflection->isPublic() && !in_array($method, $this->public_but_not_allowed)) {
                ...
                if (stristr($method, 'highlight')) {
                    $examples[$method] = str_replace(array(
                                                         ' align="left"',
                                                         ' align="right"'
                                                     ), '', $examples[$method]);
                }
    ...
    private function getTags($text)
    {
        ...
        for ($i = 0; $i < $c; $i++) {
            ...
            if (method_exists($this, $tags[$i])) {
                $new_tags[]   = "#{$full_tag}#";
                $new_values[] = call_user_func_array(array(
                                                         $this,
                                                         $tags[$i]
                                                     ), array($params));
            } elseif ($tags[$i] == 'help') {
    ...
    {
        $rows = $this->runSql("SELECT SQL_CACHE COUNT(DISTINCT i_id) AS tot FROM `##link`, `##individuals` WHERE i_id=l_from AND i_file=l_file AND l_file=" . $this->tree->getTreeId() . " AND l_type='SOUR'");
    ...
    {
        $rows = $this->runSql("SELECT SQL_CACHE COUNT(DISTINCT f_id) AS tot FROM `##link`, `##families` WHERE f_id=l_from AND f_file=l_file AND l_file=" . $this->tree->getTreeId() . " AND l_type='SOUR'");
     ...
     * @return string
     */
    public function commonSurnames($params = array(
        '',
        '',
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonSurnamesTotals($params = array(
        '',
        '',
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonSurnamesList($params = array(
        '',
        '',
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonSurnamesListTotals($params = array(
        '',
        '',
        'rcount'
    )) {
            ...
            switch ($type) {
				...
				');
                    $lookup = array(
                        ...
                        'U' => I18N::translate_c('unknown gender', 'Unknown'),
     ...
     * @return string
     */
    public function commonGiven($params = array(
        1,
        10,
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonGivenTotals($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenList($params = array(
        1,
        10,
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonGivenListTotals($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenTable($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenFemale($params = array(
        1,
        10,
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonGivenFemaleTotals($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenFemaleList($params = array(
        1,
        10,
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonGivenFemaleListTotals($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenFemaleTable($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenMale($params = array(
        1,
        10,
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonGivenMaleTotals($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenMaleList($params = array(
        1,
        10,
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonGivenMaleListTotals($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenMaleTable($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenUnknown($params = array(
        1,
        10,
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonGivenUnknownTotals($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenUnknownList($params = array(
        1,
        10,
        'alpha'
    )) {
     ...
     * @return string
     */
    public function commonGivenUnknownListTotals($params = array(
        1,
        10,
        'rcount'
    )) {
     ...
     * @return string
     */
    public function commonGivenUnknownTable($params = array(
        1,
        10,
        'rcount'
    )) {
    ...
    {
        if (Auth::check()) {
            return Filter::escapeHtml(Auth::user()
                                          ->getUserName());
    ...
    {
        return Auth::check() ? Filter::escapeHtml(Auth::user()
                                                      ->getRealName()) : '';
    }
