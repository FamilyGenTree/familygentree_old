...
class Filter
{
            ...
            $tmp = filter_input_array(
                ...
                array(
                    $variable => array(
                        ...
                        'options' => function ($x) {
                            return !function_exists('mb_convert_encoding') || mb_check_encoding($x, 'UTF-8') ? $x
                                : false;
                        }
                    ),
                )
    ...
    {
        return filter_input(INPUT_GET, $variable, FILTER_VALIDATE_INT, array(
            'options' => array(
                'min_range' => $min,
                'max_range' => $max,
                'default'   => $default
    ...
    {
        return filter_input(INPUT_POST, $variable, FILTER_VALIDATE_INT, array(
            'options' => array(
                'min_range' => $min,
                'max_range' => $max,
                'default'   => $default
