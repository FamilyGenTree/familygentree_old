...
class GedcomRecord
{
    ...
    protected function addName($type, $value, $gedcom)
    {
        $this->_getAllNames[] = array(
            ...
            'full'   => '<span dir="auto">' . Filter::escapeHtml($value) . '</span>',
     ...
     * @param boolean $sort
     * @param integer $access_level
     * @param boolean $override Include private records, to allow us to implement $SHOW_PRIVATE_RELATIONSHIPS and
     *                          $SHOW_LIVING_NAMES.
     *
     * @return Fact[]
     */
