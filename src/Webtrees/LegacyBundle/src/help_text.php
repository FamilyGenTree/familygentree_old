...
switch ($help) {
    ...
    case 'DATE':
        ...
        switch (preg_replace('/[^DMY]/', '', str_replace(array(
                                                             'J',
                                                             'F'
                                                         ), array(
                                                             'D',
...
// This help text is used for all NAME components
    case 'NAME':
        ...
        $text  =
            '<p>' .
            I18N::translate('The <b>name</b> field contains the individual’s full name, as they would have spelled it or as it was recorded.  This is how it will be displayed on screen.  It uses standard genealogical annotations to identify different parts of the name.') .
            '</p>' .
            '<ul><li>' .
    ...
    case 'PEDIGREE_LAYOUT':
        $title = /* I18N: A site configuration setting */
            I18N::translate('Default pedigree chart layout');
        $text  = /* I18N: Help text for the “Default pedigree chart layout” tree configuration setting */
            I18N::translate('This option indicates whether the pedigree chart should be generated in landscape or portrait mode.');
        break;
    ...
    case 'edit_edit_raw':
        ...
        $text  =
            ...
            '<br><br>' .
            /* I18N: %s is a URL */
            I18N::translate('You can download a copy of the GEDCOM specification from %s.', '<a href="http://wiki.webtrees.net/w/images-en/Ged551-5.pdf">http://wiki.webtrees.net/w/images-en/Ged551-5.pdf</a>');
        break;
