...
if ($action === 'download') {
    ...
    if ($zip === 'yes') {
        $temp_dir = Config::get(Config::DATA_DIRECTORY) . 'tmp-' . WT_GEDCOM . '-' . date('YmdHis') . '/';
        ...
        <dl>
            ...
            <dd>
                <input type="radio" name="privatize_export" value="none"
                       checked>&nbsp;&nbsp;<?php echo I18N::translate('None'); ?>
                <br>
                <input type="radio" name="privatize_export"
                       value="gedadmin">&nbsp;&nbsp;<?php echo I18N::translate('Manager'); ?>
                <br>
                <input type="radio" name="privatize_export"
                       value="user">&nbsp;&nbsp;<?php echo I18N::translate('Member'); ?>
                <br>
                <input type="radio" name="privatize_export"
