...
switch (Filter::get('action')) {
    ...
    case 'login':
        ...
        break;
    case 'tracking':
        $controller->setPageTitle(/* I18N: e.g. http://www.google.com/analytics */
...
<form method="post" class="form-horizontal">
    ...
    <?php if (Filter::get('action') === 'site'): ?>
        ...
        <div class="form-group">
            <label for="INDEX_DIRECTORY" class="col-sm-3 control-label">
                <?php echo /* I18N: A site configuration setting */
                I18N::translate('Data folder'); ?>
            </label>

            <div class="col-sm-9">
                <input type="text" class="form-control" dir="ltr" id="INDEX_DIRECTORY" name="INDEX_DIRECTORY"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('INDEX_DIRECTORY')); ?>" maxlength="255"
                       placeholder="data/" required>

                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the "Data folder" site configuration setting */
                ...
                <p class="small text-muted">
                    <?php echo /* I18N: “Apache” is a software program. */
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="MEMORY_LIMIT" name="MEMORY_LIMIT"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('MEMORY_LIMIT')); ?>"
                       pattern="[0-9]+[KMG]" placeholder="<?php echo get_cfg_var('memory_limit'); ?>" maxlength="255">

                <p class="small text-muted">
                    <?php echo /* I18N: %s is an amount of memory, such as 32MB */
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="MAX_EXECUTION_TIME" name="MAX_EXECUTION_TIME"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('MAX_EXECUTION_TIME')); ?>"
                       pattern="[0-9]*" placeholder="<?php echo get_cfg_var('max_execution_time'); ?>" maxlength="255">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="SESSION_TIME" name="SESSION_TIME"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('SESSION_TIME')); ?>" pattern="[0-9]*"
                       placeholder="7200" maxlength="255">

                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the “Session timeout” site configuration setting */
                    I18N::translate('The time in seconds that a webtrees session remains active before requiring a login.  The default is 7200, which is 2 hours.'); ?>
                    <?php echo I18N::translate('If you leave this setting empty, the default value will be used.'); ?>
                </p>
            </div>
        </div>
    ...
    <?php elseif (Filter::get('action') === 'email'): ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="email" class="form-control" id="SMTP_FROM_NAME" name="SMTP_FROM_NAME"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('SMTP_FROM_NAME')); ?>"
                       placeholder="no-reply@localhost" maxlength="255">

                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the “Sender name” site configuration setting */
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="SMTP_HOST" name="SMTP_HOST"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('SMTP_HOST')); ?>"
                       placeholder="smtp.example.com" maxlength="255" pattern="[a-z0-9-]+(\.[a-z0-9-]+)*">

                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the “Server name” site configuration setting */
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="SMTP_PORT" name="SMTP_PORT"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('SMTP_PORT')); ?>" pattern="[0-9]*"
                       placeholder="25" maxlength="5">

                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the "Port number" site configuration setting */
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="SMTP_AUTH_USER" name="SMTP_AUTH_USER"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('SMTP_AUTH_USER')); ?>" maxlength="255">

                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the "Username" site configuration setting */
                    I18N::translate('The user name required for authentication with the SMTP server.'); ?>
                </p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the "Password" site configuration setting */
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="SMTP_HELO" name="SMTP_HELO"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('SMTP_HELO')); ?>"
                       placeholder="localhost" maxlength="255" pattern="[a-z0-9-]+(\.[a-z0-9-]+)*">

                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the "Sending server name" site configuration setting */
                    I18N::translate('Many mail servers require that the sending server identifies itself correctly, using a valid domain name.'); ?>
                </p>
            </div>
        </div>
    ...
    <?php elseif (Filter::get('action') === 'login'): ?>
        ...
        <div class="form-group">
            <label for="LOGIN_URL" class="col-sm-3 control-label">
                <?php echo /* I18N: A site configuration setting */
                I18N::translate('Login URL'); ?>
            </label>

            <div class="col-sm-9">
                <input type="text" class="form-control" id="LOGIN_URL" name="LOGIN_URL"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('LOGIN_URL')); ?>" maxlength="255">

                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the "Login URL" site configuration setting */
                    I18N::translate('You only need to enter a Login URL if you want to redirect to a different website or location when your users login.  This is very useful if you need to switch from http to https when your users login.  Include the full URL to <i>login.php</i>.  For example, https://www.yourserver.com/webtrees/login.php .'); ?>
                </p>
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="WELCOME_TEXT_AUTH_MODE" class="col-sm-3 control-label">
                <?php echo /* I18N: A site configuration setting */
                I18N::translate('Welcome text on login page'); ?>
            </label>
        ...
        <div class="form-group">
            <label for="WELCOME_TEXT_AUTH_MODE_4" class="col-sm-3 control-label">
                <?php echo /* I18N: A site configuration setting */
                I18N::translate('Custom welcome text'); ?>
            </label>

            <div class="col-sm-9">
                <input type="text" class="form-control" id="WELCOME_TEXT_AUTH_MODE_4" name="WELCOME_TEXT_AUTH_MODE_4"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('WELCOME_TEXT_AUTH_MODE_' . WT_LOCALE)); ?>"
                       maxlength="255">

                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the "Custom welcome text" site configuration setting */
                    I18N::translate('To set this text for other languages, you must switch to that language, and visit this page again.'); ?>
                </p>
            </div>
        </div>
    ...
    <?php elseif (Filter::get('action') === 'tracking'): ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <p class="small text-muted">
                    <?php echo /* I18N: Help text for the "Site verification code for Google Webmaster Tools" site configuration setting */
        ...
        <div class="form-group">
            <label for="GOOGLE_ANALYTICS_ID" class="col-sm-3 control-label">
                <?php echo /* I18N: A site configuration setting */
                I18N::translate('Site identification code'); ?>
                <span class="sr-only">Google Analytics</span>
            </label>

            <div class="col-sm-9">
                <input type="text" class="form-control" id="GOOGLE_ANALYTICS_ID" name="GOOGLE_ANALYTICS_ID"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('GOOGLE_ANALYTICS_ID')); ?>"
                       placeholder="UA-12345-6" maxlength="255" pattern="UA-[0-9]+-[0-9]+">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="PIWIK_SITE_ID" name="PIWIK_SITE_ID"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('PIWIK_SITE_ID')); ?>" maxlength="255"
                       pattern="[0-9]+">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="PIWIK_URL" name="PIWIK_URL"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('PIWIK_URL')); ?>"
                       placeholder="e.g. piwik/ or http://example.com/piwik/" maxlength="255">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="STATCOUNTER_PROJECT_ID" name="STATCOUNTER_PROJECT_ID"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('STATCOUNTER_PROJECT_ID')); ?>"
        ...
        <div class="form-group">
            <label for="STATCOUNTER_SECURITY_ID" class="col-sm-3 control-label">
                <?php echo /* I18N: A site configuration setting */
                I18N::translate('Security code'); ?>
            </label>

            <div class="col-sm-9">
                <input type="text" class="form-control" id="STATCOUNTER_SECURITY_ID" name="STATCOUNTER_SECURITY_ID"
                       value="<?php echo Filter::escapeHtml(Site::getPreference('STATCOUNTER_SECURITY_ID')); ?>"
