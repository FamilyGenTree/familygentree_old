...
function mediaFileInfo($media_folder, $media_path, $file)
{
    ...
    if ($file && file_exists($full_path)) {
        ...
        if ($size !== false) {
            ...
            if (is_array($imgsize)) {
                $imgsize = /* I18N: image dimensions, width × height */
...
<form>
    <table class="table table-bordered table-condensed">
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" name="files" value="local" <?php echo $files === 'local' ? 'checked' : ''; ?>
                           onchange="this.form.submit();">
                    <?php echo /* I18N: “Local files” are stored on this computer */
                    I18N::translate('Local files'); ?>
                </label>
                <br>
                <label>
                    <input type="radio" name="files" value="external" <?php echo $files === 'external' ? 'checked'
                        : ''; ?> onchange="this.form.submit();">
                    <?php echo /* I18N: “External files” are stored on other computers */
                    I18N::translate('External files'); ?>
                </label>
                <br>
                <label>
                    <input type="radio" name="files" value="unused" <?php echo $files === 'unused' ? 'checked' : ''; ?>
                           onchange="this.form.submit();">
            ...
            <td>
                <?php if ($files === 'local' || $files === 'unused'): ?>
                    ...
                    <label>
                        <input type="radio" name="subfolders" value="include" <?php echo $subfolders === 'include'
                            ? 'checked' : ''; ?> onchange="this.form.submit();">
                        <?php echo I18N::translate('Include subfolders'); ?>
                    </label>
                    <br>
                    <label>
                        <input type="radio" name="subfolders" value="exclude" <?php echo $subfolders === 'exclude'
                            ? ' checked' : ''; ?> onchange="this.form.submit();">
