...
$modules = Module::getActiveSidebars(WT_GED_ID, WT_PRIV_HIDE);
            ...
            <tr class="sortme">
                <td class="col-xs-1">
                    <?php if ($module instanceof ModuleConfigInterface): ?>
                        <a href="<?php echo $module->getConfigLink(); ?>"><?php echo $module->getTitle(); ?> <i
                ...
                <td class="col-xs-1"><input type="text" size="3" value="<?php echo $order; ?>"
                                            name="order-<?php echo $module->getName(); ?>"></td>
                <td class="col-xs-5">
                    <table class="table">
                        <tbody>
                        <?php foreach (Tree::getAll() as $tree): ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo FunctionsEdit::i()->edit_field_access_level('access-' . $module->getName() . '-' . $tree->getTreeId(), $module->getAccessLevel($tree, 'sidebar')); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
