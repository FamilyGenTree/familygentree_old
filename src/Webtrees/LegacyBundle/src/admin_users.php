...
switch (Filter::get('action')) {
    case 'loadrows':
        ...
        Auth::user()
            ->setPreference('admin_users_page_size', $length);
        if ($length > 0) {
    ...
    case 'edit':
        ...
        <form class="form-horizontal" name="newform" method="post" role="form" action="?action=edit" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input class="form-control" type="text" id="real_name" name="real_name" required maxlength="64"
                           value="<?php echo Filter::escapeHtml($user->getRealName()); ?>" autofocus>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input class="form-control" type="text" id="username" name="username" required maxlength="32"
                           value="<?php echo Filter::escapeHtml($user->getUserName()); ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input class="form-control" type="password" id="pass1" name="pass1"
                           ...
                           placeholder="<?php echo I18N::plural('Use at least %s character.', 'Use at least %s characters.', WT_MINIMUM_PASSWORD_LENGTH, I18N::number(WT_MINIMUM_PASSWORD_LENGTH)); ?>" <?php echo $user->getUserId()
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input class="form-control" type="password" id="pass2" name="pass2"
                           pattern="<?php echo WT_REGEX_PASSWORD; ?>"
                           placeholder="<?php echo I18N::translate('Type the password again.'); ?>" <?php echo $user->getUserId()
                        ? '' : 'required'; ?>>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input class="form-control" type="email" id="email" name="email" required maxlength="64"
                           value="<?php echo Filter::escapeHtml($user->getEmail()); ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="verified" value="1" <?php echo $user->getPreference('verified')
                                ? 'checked' : ''?>>
                            <?php echo I18N::translate('Email verified'); ?>
                        </label>
                        <label>
                            <input type="checkbox" name="approved"
                                   value="1" <?php echo $user->getPreference('verified_by_admin') ? 'checked' : ''; ?>>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="auto_accept"
                                   value="1" <?php echo $user->getPreference('auto_accept') ? 'checked' : ''; ?>>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" id="visible_online" name="visible_online"
                                   value="1" <?php echo $user->getPreference('visible_online') ? 'checked' : ''; ?>>
                            <?php echo /* I18N: A configuration setting */
                            I18N::translate('Visible to other users when online'); ?>
                        </label>
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="contactmethod">
                    <?php echo /* I18N: A configuration setting */
                    I18N::translate('Preferred contact method'); ?>
                </label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" id="comment" name="comment" rows="5"
                              maxlength="255"><?php echo Filter::escapeHtml($user->getPreference('comment')); ?></textarea>
                </div>
            </div>
                    ...
                    <tr>
                            ...
                            <select name="canedit<?php echo $tree->getTreeId(); ?>">
                                <?php foreach ($ALL_EDIT_OPTIONS as $EDIT_OPTION => $desc): ?>
                                    <option value="<?php echo $EDIT_OPTION; ?>"
                                        <?php echo $EDIT_OPTION === $tree->getUserPreference($user, 'canedit')
                                            ? 'selected' : ''; ?>
                                        >
                                        <?php echo $desc; ?>
                                    </option>
                        ...
                        <td>
                            <select name="RELATIONSHIP_PATH_LENGTH<?php echo $tree->getTreeId(); ?>"
                                    id="RELATIONSHIP_PATH_LENGTH<?php echo $tree->getTreeId(); ?>" class="relpath">
                                <?php for ($n = 0; $n <= 10; ++$n): ?>
                                    <option
                                        value="<?php echo $n; ?>" <?php echo $tree->getUserPreference($user, 'RELATIONSHIP_PATH_LENGTH') === $n
                                        ? 'checked' : ''; ?>>
    ...
    default:
        $controller
			...
			jQuery(".table-user-list").dataTable({
				...
				autoWidth: false,
				pageLength: ' . Auth::user()
                                    ->getPreference('admin_users_page_size', 10) . ',
				sorting: [[2,"asc"]],
				columns: [
