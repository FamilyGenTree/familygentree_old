...
switch ($action) {
    ...
    default:
		...
		<div><input type="submit" value="', /* I18N: button label */
        I18N::translate('continue'), '"></div>
		</form>
	</div>';
        echo '</div>';
    ...
    case 'register':
                ...
                if ($mail1_method != 'messaging3' && $mail1_method != 'mailto' && $mail1_method != 'none') {
                    Database::prepare("INSERT INTO `##message` (sender, ip_address, user_id, subject, body) VALUES (? ,? ,? ,? ,?)")
                            ->execute(array(
                                          ...
                                          $webmaster->getUserId(),
                                          $mail1_subject,
                                          Filter::unescapeHtml($mail1_body)
                                      ));
                }
        ...
        <div id="login-register-page">
            ...
            <?php endif; ?>
            <div id="register-box">
                <form id="register-form" name="register-form" method="post" onsubmit="return checkform(this);"
                      autocomplete="off">
                    ...
                    <div>
                        <label for="user_realname">
                            ...
                            <input type="text" id="user_realname" name="user_realname" required maxlength="64"
                                   value="<?php echo Filter::escapeHtml($user_realname); ?>" autofocus>
                        </label>
                    ...
                    <div>
                        <label for="user_email">
                            ...
                            <input type="email" id="user_email" name="user_email" required maxlength="64"
                                   value="<?php echo Filter::escapeHtml($user_email); ?>">
                        </label>
                    ...
                    <div>
                        <label for="username">
                            ...
                            <input type="text" id="username" name="user_name" required maxlength="32"
                                   value="<?php Filter::escapeHtml($user_name); ?>">
                        </label>
                    ...
                    <div>
                        <label for="user_password01">
                            ...
                            <input required
                                   ...
                                   placeholder="<?php echo /* I18N: placeholder text for new-password field */
                                   I18N::plural('Use at least %s character.', 'Use at least %s characters.', WT_MINIMUM_PASSWORD_LENGTH, I18N::number(WT_MINIMUM_PASSWORD_LENGTH)); ?>"
                    ...
                    <div>
                        <label for="user_password02">
                            ...
                            <input required
                                   ...
                                   placeholder="<?php echo /* I18N: placeholder text for repeat-password field */
                                   I18N::translate('Type the password again.'); ?>"
                                   pattern="<?php echo WT_REGEX_PASSWORD; ?>"
                                >
                        </label>
                    ...
                    <div>
                        <label for="user_comments">
                            ...
                            <textarea required
                                      ...
                                      placeholder="<?php /* I18N: placeholder text for registration-comments field */
                                      I18N::translate('Explain why you are requesting an account.'); ?>"
                                >
