...
function print_family_parents(Family $family, $sosa = 0, $label = '', $parid = '', $gparid = '')
{
    ...
    if ($hfam) {
        ...
        if ($hfam && $hfam->getHusband()) {
            echo "<table style=\"width: " . ($pbwidth) . "px; height: " . $pbheight . "px;\" border=\"0\"><tr>";
            if ($sosa > 0) {
                print_sosa_number($sosa * 4, $hfam->getHusband()
                                                  ->getXref(), "down");
            }
            if (!empty($gparid)
                && $hfam->getHusband()
    ...
    if ($hfam && ($sosa != -1)) {
        ...
        print_url_arrow(($sosa == 0 ? '?famid=' . $hfam->getXref() . '&amp;ged=' . WT_GEDURL
    ...
    if ($hfam) {
        ...
        if ($hfam && $hfam->getWife()) {
            echo "<table style=\"width: " . ($pbwidth) . "px; height: " . $pbheight . "px;\" border=\"0\"><tr>";
            if ($sosa > 0) {
                print_sosa_number($sosa * 4 + 1, $hfam->getWife()
                                                      ->getXref(), "down");
            }
            if (!empty($gparid)
                && $hfam->getWife()
    ...
    if ($hfam) {
        ...
        if ($hfam && $hfam->getHusband()) {
            echo "<table style=\"width: " . ($pbwidth) . "px; height: " . $pbheight . "px;\"><tr>";
            if ($sosa > 0) {
                print_sosa_number($sosa * 4 + 2, $hfam->getHusband()
                                                      ->getXref(), "down");
            }
            if (!empty($gparid)
                && $hfam->getHusband()
    ...
    if ($hfam) {
        ...
        if ($hfam && $hfam->getWife()) {
            echo "<table style=\"width: " . ($pbwidth) . "px; height: " . $pbheight . "px;\"><tr>";
            if ($sosa > 0) {
                print_sosa_number($sosa * 4 + 3, $hfam->getWife()
                                                      ->getXref(), "down");
            }
            if (!empty($gparid)
                && $hfam->getWife()
