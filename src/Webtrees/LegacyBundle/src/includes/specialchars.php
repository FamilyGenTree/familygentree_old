...
class SpecialChars
{
    ...
    public static function special_char_translation($language_filter)
    {
        ...
        return [
            'lcspecialchars'        => $lcspecialchars,
            'ucspecialchars'        => $ucspecialchars,
            'otherspecialchars'     => $otherspecialchars,
            'specialchar_languages' => $specialchar_languages
        ];
    }
}