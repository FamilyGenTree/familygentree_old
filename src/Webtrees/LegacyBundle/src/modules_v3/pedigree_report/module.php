...
/**
 * Class pedigree_report_WT_Module
 */
class pedigree_report_WT_Module extends Module implements ModuleReportInterface
{
    /** {@inheritdoc} */
    ...
    public function getReportMenus(FactoryInterface $factory, array $options)
    {
        ...
        $menu    = $factory->createItem(
            $this->getTitle(),
            [
                'uri'        => UrlConstants::url(UrlConstants::REPORTENGINE_PHP, 'ged=' . WT_GEDURL
                                                                                  . '&amp;action=setup&amp;report=' . WT_MODULES_DIR . $this->getName()
                                                                                  . '/report.xml&amp;pid='
                                                                                  . $controller->getSignificantIndividual()
                                                                                               ->getXref()),
                'attributes' => [
