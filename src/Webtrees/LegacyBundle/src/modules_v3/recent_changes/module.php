 ...
 */
class recent_changes_WT_Module extends Module implements ModuleBlockInterface
{
    ...
    public function getBlock($block_id, $template = true, $cfg = null)
    {
        ...
        $title .= /* I18N: title for list of recent changes */
            I18N::plural('Changes in the last %s day', 'Changes in the last %s days', $days, I18N::number($days));
