 ...
 */
class googlemap_WT_Module extends Module implements ModuleConfigInterface, ModuleTabInterface
{
    /** {@inheritdoc} */
    ...
    {
        return /* I18N: The name of a module.  Google Maps™ is a trademark.  Do not translate it? http://en.wikipedia.org/wiki/Google_maps */
            I18N::translate('Google Maps™');
    }

    /** {@inheritdoc} */
    public function getDescription()
    {
        return /* I18N: Description of the “Google Maps™” module */
            I18N::translate('Show the location of places and events using the Google Maps™ mapping service.');
    }
    ...
    private function config()
    {
        ...
        if ($action == 'update') {
            $this->setSetting('GM_MAP_TYPE', Filter::post('NEW_GM_MAP_TYPE'));
            $this->setSetting('GM_USE_STREETVIEW', Filter::post('NEW_GM_USE_STREETVIEW'));
            $this->setSetting('GM_MIN_ZOOM', Filter::post('NEW_GM_MIN_ZOOM'));
            $this->setSetting('GM_MAX_ZOOM', Filter::post('NEW_GM_MAX_ZOOM'));
            $this->setSetting('GM_XSIZE', Filter::post('NEW_GM_XSIZE'));
            $this->setSetting('GM_YSIZE', Filter::post('NEW_GM_YSIZE'));
            $this->setSetting('GM_PRECISION_0', Filter::post('NEW_GM_PRECISION_0'));
            $this->setSetting('GM_PRECISION_1', Filter::post('NEW_GM_PRECISION_1'));
            $this->setSetting('GM_PRECISION_2', Filter::post('NEW_GM_PRECISION_2'));
            $this->setSetting('GM_PRECISION_3', Filter::post('NEW_GM_PRECISION_3'));
            $this->setSetting('GM_PRECISION_4', Filter::post('NEW_GM_PRECISION_4'));
            $this->setSetting('GM_PRECISION_5', Filter::post('NEW_GM_PRECISION_5'));
            $this->setSetting('GM_COORD', Filter::post('NEW_GM_COORD'));
            $this->setSetting('GM_PLACE_HIERARCHY', Filter::post('NEW_GM_PLACE_HIERARCHY'));
            $this->setSetting('GM_PH_XSIZE', Filter::post('NEW_GM_PH_XSIZE'));
            $this->setSetting('GM_PH_YSIZE', Filter::post('NEW_GM_PH_YSIZE'));
            $this->setSetting('GM_PH_MARKER', Filter::post('NEW_GM_PH_MARKER'));
            $this->setSetting('GM_DISP_SHORT_PLACE', Filter::post('NEW_GM_DISP_SHORT_PLACE'));

            for ($i = 1; $i <= 9; $i++) {
                $this->setSetting('GM_PREFIX_' . $i, Filter::post('NEW_GM_PREFIX_' . $i));
                $this->setSetting('GM_POSTFIX_' . $i, Filter::post('NEW_GM_POSTFIX_' . $i));
            }
        ...
        <form method="post" name="configform" action="module.php?mod=googlemap&mod_action=admin_config">
            ...
            <div id="tabs">
                <ul>
                    <li><a href="#gm_basic"><span><?php echo I18N::translate('Basic'); ?></span></a></li>
                    <li><a href="#gm_advanced"><span><?php echo I18N::translate('Advanced'); ?></span></a></li>
                    <li><a href="#gm_ph"><span><?php echo I18N::translate('Place hierarchy'); ?></span></a></li>
                </ul>
                <div id="gm_basic">
                    <table class="gm_edit_config">
                        <tr>
                            ...
                            <td>
                                <select name="NEW_GM_MAP_TYPE">
                                    <option value="ROADMAP" <?php if ($this->getSetting('GM_MAP_TYPE') === 'ROADMAP') {
                                        echo "selected";
                                    } ?>><?php echo I18N::translate('Map'); ?></option>
                                    <option
                                        value="SATELLITE" <?php if ($this->getSetting('GM_MAP_TYPE') === 'SATELLITE') {
                                        echo "selected";
                                    } ?>><?php echo I18N::translate('Satellite'); ?></option>
                                    <option value="HYBRID" <?php if ($this->getSetting('GM_MAP_TYPE') === 'HYBRID') {
                                        echo "selected";
                                    } ?>><?php echo I18N::translate('Hybrid'); ?></option>
                                    <option value="TERRAIN" <?php if ($this->getSetting('GM_MAP_TYPE') === 'TERRAIN') {
                                        echo "selected";
                                    } ?>><?php echo I18N::translate('Terrain'); ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="NEW_GM_XSIZE"
                                       value="<?php echo $this->getSetting('GM_XSIZE'); ?>" size="10">
                                <?php echo I18N::translate('Height'); ?>
                                <input type="text" name="NEW_GM_YSIZE"
                                       value="<?php echo $this->getSetting('GM_YSIZE'); ?>" size="10">
                            </td>
                        </tr>
                        <tr>
				...
				<div id=" gm_advanced
                                    ...
                                    <table class="gm_edit_config">
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td><select name="NEW_GM_PRECISION_0">
                                                                <?php for ($j = 0; $j < 10; $j++) { ?>
											<option value="<?php echo $j; ?>" <?php if ($this->getSetting('GM_PRECISION_0') == $j) {
                                                                    echo "selected";
                                                                }
                                                                    echo ">", $j; ?></option>
											<?php } ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select name="NEW_GM_PRECISION_1">
                                                                <?php for ($j = 0; $j < 10; $j++) { ?>
											<option value="<?php echo $j; ?>" <?php if ($this->getSetting('GM_PRECISION_1') == $j) {
                                                                    echo "selected";
                                                                }
                                                                    echo ">", $j; ?></option>
											<?php } ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select name="NEW_GM_PRECISION_2">
                                                                <?php for ($j = 0; $j < 10; $j++) { ?>
											<option value="<?php echo $j; ?>" <?php if ($this->getSetting('GM_PRECISION_2') == $j) {
                                                                    echo "selected";
                                                                }
                                                                    echo ">", $j; ?></option>
											<?php } ?>
                                                    ...
                                                    <tr>
                                                        <td><?php echo I18N::translate('Neighborhood'); ?>
                                                            &nbsp;&nbsp;</td>
                                                        <td><select name="NEW_GM_PRECISION_3">
                                                                <?php for ($j = 0; $j < 10; $j++) { ?>
											<option value="<?php echo $j; ?>" <?php if ($this->getSetting('GM_PRECISION_3') == $j) {
                                                                    echo "selected";
                                                                }
                                                                    echo ">", $j; ?></option>
											<?php } ?>
                                                    ...
                                                    <tr>
                                                        <td><?php echo I18N::translate('House'); ?>&nbsp;&nbsp;</td>
                                                        <td><select name="NEW_GM_PRECISION_4">
                                                                <?php for ($j = 0; $j < 10; $j++) { ?>
											<option value="<?php echo $j; ?>" <?php if ($this->getSetting('GM_PRECISION_4') == $j) {
                                                                    echo "selected";
                                                                }
                                                                    echo ">", $j; ?></option>
											<?php } ?>
                                                    ...
                                                    <tr>
                                                        <td><?php echo I18N::translate('Max'); ?>&nbsp;&nbsp;</td>
                                                        <td><select name="NEW_GM_PRECISION_5">
                                                                <?php for ($j = 0; $j < 10; $j++) { ?>
											<option value="<?php echo $j; ?>" <?php if ($this->getSetting('GM_PRECISION_5') == $j) {
                                                                    echo "selected";
                                                                }
                                                                    echo ">", $j; ?></option>
											<?php } ?>
                                        ...
                                        <tr class="gm_levels">
                                            ...
                                            <td>
                                                <input type="text" size="30" name="NEW_GM_PREFIX_<?php echo $level; ?>"
                                                       value="<?php echo $this->getSetting('GM_PREFIX_' . $level); ?>">
                                            </td>
                                            <td>
                                                <input type="text" size="30" name="NEW_GM_POSTFIX_<?php echo $level; ?>"
                                                       value="<?php echo $this->getSetting('GM_POSTFIX_' . $level); ?>">
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </table>
                ...
                <div id="gm_ph">
                    <table class="gm_edit_config">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo I18N::translate('Width'); ?>
                                <input type="text" name="NEW_GM_PH_XSIZE"
                                       value="<?php echo $this->getSetting('GM_PH_XSIZE'); ?>" size="10">
                                <?php echo I18N::translate('Height'); ?>
                                <input type="text" name="NEW_GM_PH_YSIZE"
                                       value="<?php echo $this->getSetting('GM_PH_YSIZE'); ?>" size="10">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="NEW_GM_PH_MARKER">
                                    <option
                                        value="G_DEFAULT_ICON" <?php if ($this->getSetting('GM_PH_MARKER') == "G_DEFAULT_ICON") {
                                        echo "selected";
                                    } ?>><?php echo I18N::translate('Standard'); ?></option>
                                    <option value="G_FLAG" <?php if ($this->getSetting('GM_PH_MARKER') == "G_FLAG") {
                                        echo "selected";
                                    } ?>><?php echo I18N::translate('Flag'); ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
    ...
    private function flags()
    {
        ...
        <form method="post" id="flags" name="flags"
              action="module.php?mod=googlemap&amp;mod_action=flags&amp;countrySelected=<?php echo $countrySelected; ?>&amp;stateSelected=<?php echo $stateSelected; ?>">
                ...
                <tr>
                    ...
                    <td class="optionbox" colspan="4">
                        <select name="STATESELECT" dir="ltr" onchange="selectCountry()">
                            <option value="States"><?php echo /* I18N: Part of a country, state/region/county */
                                I18N::translate('Subdivision'); ?></option>
    ...
    private function pedigreeMap()
    {
        ...
        $controller
            ->setPageTitle(/* I18N: %s is an individual’s name */
                I18N::translate('Pedigree map of %s', $controller->getPersonName()))
            ->pageHeader()
            ...
            if (!empty($person)) {
                ...
                if ($latlongval[$i]) {
                    $lat[$i] = str_replace(array(
                                               ...
                                               '-',
                                               '.'
                                           ), $latlongval[$i]->pl_lati);
                    $lon[$i] = str_replace(array(
                                               'E',
                                               'W',
                                               ','
                                           ), array(
        ...
        if (isset($curgen)) {
            ...
            if ($count + $priv != $total) {
                if ($miscount == 0) {
                    ...
                    echo /* I18N: %1$d is a count of individuals, %2$s is a list of their names */
                    I18N::plural(
    ...
    private function pedigreeMapJavascript($hideflags, $hidelines)
    {
        ...
        for ($i = 0; $i < $controller->treesize; $i++) {
            ...
            if ($person) {
                ...
                $dataright = Filter::escapeJs('<br><strong>' . I18N::translate('Birth:') . '&nbsp;</strong>' . $person->getBirthDate()
                                                                                                                      ->display() . ' — ' . $person->getBirthPlace());

                $latlongval[$i] = $this->getLatitudeAndLongitudeFromPlaceLocation($person->getBirthPlace());
                if ($latlongval[$i]) {
                    $lat[$i] = (double)str_replace(array(
                                                       'N',
                                                       'S',
                                                       ','
                                                   ), array(
                    ...
                    $lon[$i] = (double)str_replace(array(
                                                       'E',
                                                       'W',
                                                       ','
                                                   ), array(
    ...
    private function adminPlaceCheck()
    {
        ...
        echo '
			<table id="gm_config">
				<tr>
					<th>
						<a href="module.php?mod=googlemap&amp;mod_action=admin_config">', I18N::translate('Google Maps™ preferences'), '</a>
					</th>
					<th>
						<a href="module.php?mod=googlemap&amp;mod_action=admin_places">
        ...
        echo '</select>';
        if ($country != 'XYZ') {
            echo '<label>', /* I18N: Part of a country, state/region/county */
            I18N::translate('Subdivision'), '</label>
            ...
            foreach ($places as $place) {
                echo '<option value="', Filter::escapeHtml($place), '" ', $place == $state ? 'selected'
                    : '', '>', Filter::escapeHtml($place), '</option>';
            }
            echo '</select>';
        }
        ...
        switch ($action) {
            case 'go':
                ...
                while ($x < $i) {
                    ...
                    while ($z < $parts) {
                        ...
                        if ($row['pl_place'] != '') {
                            ...
                            if ($levels[$z] == "unknown") {
                                $placestr2 = $mapstr_add . $id . "&amp;level=" . $level . $mapstr3 . $mapstr7 . "<strong>" . rtrim(ltrim(I18N::translate('unknown'))) . "</strong>" . $mapstr8;
                                $matched[$x]++;
                            } else {
                ...
                echo '<tr><td colspan="2" class="accepted">', /* I18N: A count of places */
                I18N::translate('Total places: %s', I18N::number($countrows)), '</td></tr></table></div>';
                break;
            default:
            ...
            if (!$fact->getPlace()
                ...
                if ($ctla && $ctlo) {
                    ...
                    $gmarks[$i] = array(
                        ...
                        'name'         => $spouse
                            ? '<a href="' . $spouse->getHtmlUrl() . '"' . $spouse->getFullName() . '</a>' : '',
                        'pl_icon'      => '',
                        'place'        => $fact->getPlace()
                                               ->getFullName(),
                        'sv_bearing'   => '0',
                        ...
                        'sv_long'      => '0',
                        'sv_zoom'      => '0',
                        'tooltip'      => $fact->getPlace()
                                               ->getGedcomName(),
                    );
                } else {
                    $latlongval = $this->getLatitudeAndLongitudeFromPlaceLocation($fact->getPlace()
                                                                                       ->getGedcomName());
                ...
                if ($birth) {
                    ...
                    if (!$birth->getPlace()
                        ...
                        if ($ctla && $ctlo) {
                            ...
                            $latlongval = $this->getLatitudeAndLongitudeFromPlaceLocation($birth->getPlace()
                                                                                                ->getGedcomName());
                            if ($latlongval && $latlongval->pl_lati && $latlongval->pl_long) {
                                $i++;
                                $gmarks[$i] = array(
    ...
    public function createMap($placelevels)
    {
        ...
        if (Auth::isAdmin()) {
            ...
            if (array_key_exists('batch_update', Module::getActiveModules())) {
        ...
        if ($STREETVIEW) {
            ...
            if ($level >= 1) {
                $pl_lati = str_replace(array(
                                           ...
                                           '-',
                                           '.'
                                       ), $latlng['pl_lati']); // WT_placelocation lati
                $pl_long = str_replace(array(
                                           'E',
                                           'W',
                                           ','
                                       ), array(
                                           ...
                                           '-',
                                           '.'
                                       ), $latlng['pl_long']); // WT_placelocation long
                ...
                <div>
                    <iframe
                        style="background: transparent; margin-top: -3px; margin-left: 2px; width: 530px; height: 405px; padding: 0; border: 0;"
                        src="module.php?mod=googlemap&amp;mod_action=wt_street_view&amp;x=<?php echo $sv_lng; ?>&amp;y=<?php echo $sv_lat; ?>&amp;z=18&amp;t=2&amp;c=1&amp;s=1&amp;b=<?php echo $sv_dir; ?>&amp;p=<?php echo $sv_pitch; ?>&amp;m=<?php echo $sv_zoom; ?>&amp;j=1&amp;k=1&amp;v=1"
                ...
                $list_latlon = (
                    ...
                    I18N::translate('Bearing') . "<input name='sv_bearText' id='sv_bearText' type='text' style='width:46px; background:none; border:none;' value='" . $sv_dir . "'>" .
                    /* I18N: Angle of elevation (in degrees), for street-view mapping */
                    I18N::translate('Elevation') . "<input name='sv_elevText' id='sv_elevText' type='text' style='width:30px; background:none; border:none;' value='" . $sv_pitch . "'>" .
    ...
    private function printGoogleMapMarkers($place2, $level, $parent, $levelm, $linklevels, $placelevels, $lastlevel = false)
    {
        if (($place2['lati'] == null) || ($place2['long'] == null) || (($place2['lati'] == '0') && ($place2['long'] == '0'))) {
            ...
            echo "</div>\", icon_type, \"", str_replace(array(
                                                            '&lrm;',
                                                            '&rlm;'
                                                        ), array(
                                                            WT_UTF8_LRM,
                                                            WT_UTF8_RLM
                                                        ), addslashes($place2['place'])), "\");\n";
        } else {
            $lati = str_replace(array(
                                    'N',
                                    'S',
                                    ','
                                ), array(
    ...
    private function placesEdit()
    {
        ...
        if ($action == 'addrecord' && Auth::isAdmin()) {
            ...
            if (($_POST['LONG_CONTROL'] == '') || ($_POST['NEW_PLACE_LONG'] == '') || ($_POST['NEW_PLACE_LATI'] == '')) {
                $statement->execute(array(
                                        ...
                                        $placeid,
                                        $level,
                                        $_POST['NEW_PLACE_NAME'],
                                        null,
                                        null,
                                        $_POST['NEW_ZOOM_FACTOR'],
                                        $_POST['icon']
                                    ));
            } else {
                $statement->execute(array(
                                        ...
                                        $level,
                                        $_POST['NEW_PLACE_NAME'],
                                        $_POST['LONG_CONTROL'][3] . $_POST['NEW_PLACE_LONG'],
                                        $_POST['LATI_CONTROL'][3] . $_POST['NEW_PLACE_LATI'],
                                        $_POST['NEW_ZOOM_FACTOR'],
                                        $_POST['icon']
                                    ));
            }
        ...
        if ($action == "update") {
            ...
            if ($row->pl_lati !== null && $row->pl_long !== null) {
                $place_lati = (float)(str_replace(array(
                                                      'N',
                                                      'S',
                                                      ','
                                                  ), array(
                ...
                $place_long = (float)(str_replace(array(
                                                      'E',
                                                      'W',
                                                      ','
                                                  ), array(
            ...
            do {
                ...
                if ($row->pl_lati !== null && $row->pl_long !== null) {
                    $parent_lati = (float)(str_replace(array(
                                                           'N',
                                                           'S',
                                                           ','
                                                       ), array(
                    ...
                    $parent_long = (float)(str_replace(array(
                                                           'E',
                                                           'W',
                                                           ','
                                                       ), array(
    ...
    <?php } ?>
        ...
        echo 'checked';
			...
			<tr>
				...
				<td class="optionbox" colspan="2">
					<input type="text" id="NEW_PLACE_LATI" name="NEW_PLACE_LATI" placeholder="<?php echo /* I18N: Measure of latitude/longitude */
    I18N::translate('degrees') ?>" value="<?php if ($place_lati != null) {
        echo abs($place_lati);
        ...
        echo ">", I18N::translate('south'); ?></option>
			...
			<tr>
				...
				<td class="optionbox" colspan="2">
					<input type="text" id="NEW_PLACE_LONG" name="NEW_PLACE_LONG" placeholder="<?php echo I18N::translate('degrees') ?>" value="<?php if ($place_long != null) {
        echo abs($place_long);
    } ?>" size="20" onchange="updateMap();">
        ...
        <?php } else { ?>
            <img alt="<?php echo /* I18N: The emblem of a country or region */
            I18N::translate('Flag'); ?>"
                 src="<?php echo WT_STATIC_URL, WT_MODULES_DIR, 'googlemap/', $place_icon; ?>">&nbsp;&nbsp;
            <a href="#"
               onclick="change_icon();return false;"><?php echo I18N::translate('Change flag'); ?></a>&nbsp;&nbsp;
    ...
    private function adminPlaces()
    {
        ...
        if ($action === 'ImportFile') {
            ...
            sort($placefiles);
            ?>
            <form method="post" enctype="multipart/form-data" id="importfile" name="importfile"
                  action="module.php?mod=googlemap&amp;mod_action=admin_places&amp;action=ImportFile2">
		...
		function updateList(inactive) {
			window.location.href='<?php if (strstr($_SERVER['REQUEST_URI'], '&inactive', true)) {
        $uri = strstr($_SERVER['REQUEST_URI'], '&inactive', true);
    } else {
        $uri = $_SERVER['REQUEST_URI'];
    }
        echo $uri, '&inactive='; ?>'+inactive;
		}
        ...
        foreach ($placelist as $place) {
            ...
            $noRows =
                Database::prepare("SELECT COUNT(pl_id) FROM `##placelocation` WHERE pl_parent_id=?")
                        ...
                        ->fetchOne();
            if ($noRows == 0) { ?>
                <td><a href="#" onclick="delete_place(<?php echo $place['place_id'] ?>);return false;"
                       class="icon-delete" title="<?php echo I18N::translate('Remove'); ?>"></a></td>
            <?php } else { ?>
