 ...
 */
class login_block_WT_Module extends Module implements ModuleBlockInterface
{
    /** {@inheritdoc} */
    ...
    {
        return /* I18N: Description of the “Login” module */
            I18N::translate('An alternative way to login and logout.');
    }
    ...
    public function getBlock($block_id, $template = true, $cfg = null)
    {
        ...
        if (Auth::check()) {
            ...
            $content .= '<br><a href="edituser.php" class="name2">' . I18N::translate('Logged in as ') . ' ' . Filter::escapeHtml(Auth::user()
                                                                                                                                      ->getRealName()) . '</a><br><br>';
