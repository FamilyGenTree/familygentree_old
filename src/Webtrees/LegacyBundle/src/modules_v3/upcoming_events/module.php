...
/**
 * Class upcoming_events_WT_Module
 */
class upcoming_events_WT_Module extends Module implements ModuleBlockInterface
{
    /** {@inheritdoc} */
    ...
    public function getBlock($block_id, $template = true, $cfg = null)
    {
        ...
        $onlyBDM   = FunctionsDbPhp::i()->get_block_setting($block_id, 'onlyBDM', '0');
        ...
        switch ($infoStyle) {
            case 'list':
                ...
                $content .= FunctionsPrintLists::i()->print_events_list($startjd, $endjd, $onlyBDM ? 'BIRT MARR DEAT' : '', $filter, $sortStyle);
                break;
            case 'table':
                // Style 2: New format, tables, big text, etc.  Not too good on right side of page
                ob_start();
                $content .= FunctionsPrintLists::i()->print_events_table($startjd, $endjd, $onlyBDM ? 'BIRT MARR DEAT' : '', $filter, $sortStyle);
