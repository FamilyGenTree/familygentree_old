                ...
                <table width="100%" class="fact_table" cellspacing="0" border="0">
                    ...
                    foreach ($person->getChildStepFamilies() as $family) {
                        ...
                        if ($people["husb"]) {
                            ...
                            $submenu = new Menu($slabel);
                            $menu->addSubmenu($submenu);
                            if ($people["husb"]->getDeathYear() == 0) {
                                $DeathYr = "";
                            } else {
                                $DeathYr = $people["husb"]->getDeathYear();
                            }
                            if ($people["husb"]->getBirthYear() == 0) {
                                $BirthYr = "";
                            } else {
                                $BirthYr = $people["husb"]->getBirthYear();
                            }
                            ?>
                            <tr>
                                <td class="facts_value">
                        ...
                        if ($people["wife"]) {
                            ...
                            $submenu = new Menu($slabel);
                            $menu->addSubmenu($submenu);
                            if ($people["wife"]->getDeathYear() == 0) {
                                $DeathYr = "";
                            } else {
                                $DeathYr = $people["wife"]->getDeathYear();
                            }
                            if ($people["wife"]->getBirthYear() == 0) {
                                $BirthYr = "";
                            } else {
                                $BirthYr = $people["wife"]->getBirthYear();
                            }
                            ?>
                            <tr>
                                <td class="facts_value">
