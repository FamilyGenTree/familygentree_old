                ...
                <table class="fact_table">
                    ...
                    foreach ($families as $family) {
                        ...
                        foreach ($family->getChildren() as $child) {
                            ...
                            $chdob   = ($child->getBirthDate()
                                              ->minJD() + $child->getBirthDate()
                                                                ->maxJD()) / 2; // Child’s Date of Birth (Julian)
                            $chdod   = ($child->getDeathDate()
                                              ->minJD() + $child->getDeathDate()
                                                                ->maxJD()) / 2; // Child’s Date of Death (Julian)
                        ...
                        if ($family->getHusband()) {
                            ...
                            <tr>
                                ...
                                <td align="left" class="facts_value nowrap">
                                    ...
                                    ?>", "<?php
                                    echo Filter::escapeHtml($fulln); // nam = Full Name
                                    ?>", "<?php
                                    if (isset($fulmn)) {
                                        echo Filter::escapeHtml($fulln); // mnam = Full Married Name
                                    } else {
                                        echo Filter::escapeHtml($fulln); // mnam = Full Name
                                    }
                                    ?>", "<?php
                                    if ($person === $gparent) {
                                        echo 'head';
                                    } else {
                                        echo Filter::escapeHtml($label);
                                    }
                                    ?>", "<?php
                                    ...
                                    ?>", "<?php
                                    echo ($gparent->getBirthDate()
                                                  ->minJD() + $gparent->getBirthDate()
                                                                      ->maxJD()) / 2; // dob = Date of Birth (Julian)
                                    ?>", "<?php
                                    echo $censyear - $gparent->getbirthyear(); // age = Census Date minus YOB
                                    ?>", "<?php
                                    echo ($gparent->getDeathDate()
                                                  ->minJD() + $gparent->getDeathDate()
                                                                      ->maxJD()) / 2; // dod = Date of Death (Julian)
                                    ?>", "<?php
                                    echo ""; // occu = Occupation
                                    ?>", "<?php
                                    echo Filter::escapeHtml($gparent->getBirthPlace()); //  birthpl = Husband Place of Birth
                                    ?>", "<?php
                                    if (isset($HusbFBP)) {
                        ...
                        if ($family->getWife()) {
                            ...
                            foreach ($gparent->getChildFamilies() as $cfamily) {
                                ...
                                $pwife = $cfamily->getWife();
                                if ($phusb) {
                                    $WifeFBP = $phusb->getBirthPlace();
                                }
                                if ($pwife) {
                                    $WifeMBP = $pwife->getBirthPlace();
                                }
                            }
                            ...
                            <tr>
                                ...
                                <td align="left" class="facts_value nowrap">
                                    ...
                                    ?>", "<?php
                                    if (isset($fulmn)) {
                                        echo Filter::escapeHtml($fulmn); // mnam = Full Married Name
                                    } else {
                                        echo Filter::escapeHtml($fulln); // mnam = Full Name
                                    }
                                    ?>", "<?php
                                    ...
                                    echo ""; // occu = Occupation
                                    ?>", "<?php
                                    echo Filter::escapeHtml($gparent->getBirthPlace()); //  birthpl = Wife Place of Birth
                                    ?>", "<?php
                                    if (isset($WifeFBP)) {
                        ...
                        foreach ($family->getChildren() as $child) {
                            ...
                            foreach ($child->getSpouseFamilies() as $childfamily) {
                                ...
                                foreach ($chchildren as $chchild) {
                                    ...
                                    $chdob   = ($chchild->getBirthDate()
                                                        ->minJD() + $chchild->getBirthDate()
                                                                            ->maxJD()) / 2; // Child’s Date of Birth (Julian)
                                    $chdod   = ($chchild->getDeathDate()
                                                        ->minJD() + $chchild->getDeathDate()
                                                                            ->maxJD()) / 2; // Child’s Date of Death (Julian)
                                    $chBLD   = ($chfulln . ", " . $chdob . ", " . $chdod);
                                    array_push($chBLDarray, $chBLD);
                                }
                            ...
                            <tr>
                                ...
                                <td align="left" class="facts_value nowrap">
                                    ...
                                    if (($child->canShow())) {
                                        ...
                                        ?>", "<?php
                                        if (isset($chfulmn)) {
                                            echo Filter::escapeHtml($chfulmn); // mnam = Full Married Name
                                        } else {
                                            echo Filter::escapeHtml($fulln); // mnam = Full Name
                                        }
                                        ?>", "<?php
                                        ...
                                        ?>", "<?php
                                        echo ($child->getBirthDate()
                                                    ->minJD() + $child->getBirthDate()
                                                                      ->maxJD()) / 2; // dob = Date of Birth (Julian)
                                        ?>", "<?php
                                        echo $censyear - $child->getbirthyear(); // age = Census Date minus YOB
                                        ?>", "<?php
                                        echo ($child->getDeathDate()
                                                    ->minJD() + $child->getDeathDate()
                                                                      ->maxJD()) / 2; // dod = Date of Death (Julian)
                                        ?>", "<?php
                                        echo ""; // occu = Occupation
                                        ?>", "<?php
                                        echo Filter::escapeHtml($child->getBirthPlace()); //  birthpl = Child Place of Birt
                                        ?>", "<?php
                                        if ($family->getHusband()) {
                                            echo Filter::escapeHtml($family->getHusband()
                                                                           ->getBirthPlace()); // fbirthpl = Child Father’s Place of Birth
                                        } else {
                                            echo 'UNK, UNK, UNK, UNK'; // fbirthpl = Child Father’s Place of Birth Not known
                                        }
                                        ?>", "<?php
                                        if ($family->getWife()) {
                                            echo Filter::escapeHtml($family->getWife()
                                                                           ->getBirthPlace()); // mbirthpl = Child Mother’s Place of Birth
                                        } else {
                        ...
                        if ($family->getHusband()) {
                            ...
                            <tr>
                                ...
                                <td align="left" class="facts_value nowrap">
                                    ...
                                    echo ""; // occu = Occupation
                                    ?>", "<?php
                                    echo Filter::escapeHtml($gparent->getBirthPlace()); //  birthpl = Step Husband Place of Birth
                                    ?>", "<?php
                                    if (isset($HusbFBP)) {
                        ...
                        if ($family->getWife()) {
                            ...
                            <tr>
                                ...
                                <td align="left" class="facts_value nowrap">
                                    ...
                                    echo ""; // occu = Occupation
                                    ?>", "<?php
                                    echo Filter::escapeHtml($gparent->getBirthPlace()); //  birthpl = Step Wife Place of Birth
                                    ?>", "<?php
                                    if (isset($WifeFBP)) {
                            ...
                            <tr>
                                ...
                                <td align="left" class="facts_value nowrap">
                                    ...
                                    if (($child->canShow())) {
                                        ...
                                        echo ""; // occu = Occupation
                                        ?>", "<?php
                                        echo Filter::escapeHtml($child->getBirthPlace()); //  birthpl = Child Place of Birth
                                        ?>", "<?php
                                        if ($family->getHusband()) {
                                            echo Filter::escapeHtml($family->getHusband()
                                                                           ->getBirthPlace()); // fbirthpl = Child Father’s Place of Birth
            ...
            if ($wife || $children) {
                if ($wife) {
                    ...
                    if ($wife->canShowName()) {
                        ...
                        $parentlinks .= "'" . (($wife->getBirthDate()
                                                     ->minJD() + $wife->getBirthDate()
                                                                      ->maxJD()) / 2) . "',"; // dob = Date of Birth
                        ...
                        $parentlinks .= "'" . (($wife->getDeathDate()
                                                     ->minJD() + $wife->getDeathDate()
                                                                      ->maxJD()) / 2) . "',"; // dod = Date of Death
                        $parentlinks .= "''" . ","; // occu  = Occupation
            ...
            if ($spouse || $children) {
                if ($spouse) {
                    ...
                    if ($spouse->canShowName()) {
                        ...
                        $spouselinks .= "'" . (($spouse->getBirthDate()
                                                       ->minJD() + $spouse->getBirthDate()
                                                                          ->maxJD()) / 2) . "',";
                        ...
                        $spouselinks .= "'" . (($spouse->getDeathDate()
                                                       ->minJD() + $spouse->getDeathDate()
                                                                          ->maxJD()) / 2) . "',"; // dod = Date of Death
            ...
            foreach ($children as $child) {
                ...
                foreach ($child->getSpouseFamilies() as $childfamily) {
                    ...
                    if ($childfamily->getHusband()) {
                        $chhusbnam = $childfamily->getHusband()
                                                 ->getAllNames();
                    }
                }
                // Childs Details -------------------------
                ...
                if ($child->canShowName()) {
                    ...
                    $spouselinks .= "'" . Filter::escapeHtml(strip_tags($fulln)) . "',"; // nam = Name
                    if (isset($chfulmn)) {
                        $spouselinks .= "'" . Filter::escapeHtml(strip_tags($chfulmn)) . "',"; // mnam = Full Married Name
                    } else {
                        $spouselinks .= "'" . Filter::escapeHtml(strip_tags($fulln)) . "',"; // mnam = Full Name
                    }
                    if ($currpid == "Son" || $currpid == "Daughter") {
                        if ($child->getSex() == "M") {
                    ...
                    $spouselinks .= "'" . (($child->getBirthDate()
                                                  ->minJD() + $child->getBirthDate()
                                                                    ->maxJD()) / 2) . "',"; // dob = Date of Birth
                    ...
                    $spouselinks .= "'" . (($child->getDeathDate()
                                                  ->minJD() + $child->getDeathDate()
                                                                    ->maxJD()) / 2) . "',"; // dod = Date of Death
                    $spouselinks .= "''" . ","; // occu  = Occupation
