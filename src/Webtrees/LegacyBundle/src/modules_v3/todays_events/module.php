    ...
    public function getBlock($block_id, $template = true, $cfg = null)
    {
        ...
        switch ($infoStyle) {
            case 'list':
                ...
                $content .= FunctionsPrintLists::i()->print_events_list($todayjd, $todayjd, $onlyBDM ? 'BIRT MARR DEAT'
                    : '', $filter, $sortStyle);
                break;
            case 'table':
                // Style 2: New format, tables, big text, etc.  Not too good on right side of page
                ob_start();
                $content .= FunctionsPrintLists::i()->print_events_table($todayjd, $todayjd, $onlyBDM ? 'BIRT MARR DEAT'
                    : '', $filter, $sortStyle);
