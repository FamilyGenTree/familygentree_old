            ...
            <td class="optionbox">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_first_birth" <?php echo $stat_first_birth
                                    ? 'checked' : ''; ?>>
                    ...
                    <tr>
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_surname" <?php echo $stat_surname
                                    ? 'checked' : ''; ?>>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_last_birth" <?php echo $stat_last_birth
                                    ? 'checked' : ''; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_first_death" <?php echo $stat_first_death
                                    ? 'checked' : ''; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_last_death" <?php echo $stat_last_death
                                    ? 'checked' : ''; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_long_life" <?php echo $stat_long_life
                                    ? 'checked' : ''; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_avg_life" <?php echo $stat_avg_life
                                    ? 'checked' : ''; ?>>
                    ...
                    <tr>
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_events" <?php echo $stat_events
                                    ? 'checked' : ''; ?>>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_most_chil" <?php echo $stat_most_chil
                                    ? 'checked' : ''; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" value="yes" name="stat_avg_chil" <?php echo $stat_avg_chil
                                    ? 'checked' : ''; ?>>
