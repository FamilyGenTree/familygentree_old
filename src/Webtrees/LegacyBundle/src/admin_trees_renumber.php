...
$controller
    ...
    ->setPageTitle(I18N::translate(/* I18N: Renumber the records in a family tree */
                       'Renumber family tree') . ' — ' . Globals::i()->WT_TREE->getTitleHtml())
    ->pageHeader();
...
if ($xrefs) {
    ...
    echo '<i class="fa fa-check"></i> ', /* I18N: Button label */
    I18N::translate('continue');
    echo '</button>';
    //echo '<input type="submit" name="go" value="', /* I18N: button label */ I18N::translate('go'), '"></p>';
    echo '<input type="hidden" name="ged" value="', Filter::escapeUrl(WT_GEDCOM), '">';
    echo '</form>';
