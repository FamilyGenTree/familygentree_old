                ...
                <?php if ($facts): ?>
                    <table class="table">
                        ...
                        <?php foreach ($facts as $fact_id => $fact): ?>
                            <tr>
                                <td>
                                    <input type="checkbox" name="keep1[]" value="<?php echo $fact->getFactId(); ?>"
                                           checked>
                                </td>
                                <td>
                                    <div class="gedcom-data"
                                         dir="ltr"><?php echo Filter::escapeHtml($fact->getGedcom()); ?></div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2 class="panel-title">
                            <?php echo /* I18N: the name of an individual, source, etc. */
                                I18N::translate('The following facts and events were only found in the record of %s.', '<a href="' . $rec1->getHtmlUrl() . '">' . $rec1->getFullName()) . '</a>'; ?>
                        </h2>
                    </div>
                    <div class="panel-body">
                        <?php if ($facts): ?>
                            <table class="table">
                                ...
                                <?php foreach ($facts1 as $fact_id => $fact): ?>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="keep1[]"
                                                   value="<?php echo $fact->getFactId(); ?>" checked>
                                        </td>
                                        <td>
                                            <div class="gedcom-data"
                                                 dir="ltr"><?php echo Filter::escapeHtml($fact->getGedcom()); ?></div>
            ...
            <div class="col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2 class="panel-title">
                            <?php echo /* I18N: the name of an individual, source, etc. */
                                I18N::translate('The following facts and events were only found in the record of %s.', '<a href="' . $rec2->getHtmlUrl() . '">' . $rec2->getFullName()) . '</a>'; ?>
                        </h2>
                    </div>
                    <div class="panel-body">
                        <?php if ($facts): ?>
                            <table class="table">
                                ...
                                <?php foreach ($facts2 as $fact_id => $fact): ?>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="keep2[]"
                                                   value="<?php echo $fact->getFactId(); ?>" checked>
                                        </td>
                                        <td>
                                            <div class="gedcom-data"
...
<?php else: ?>
    ...
    <form class="form form-horizontal">
        ...
        <p><?php echo /* I18N: Records are indviduals, sources, etc. */
            I18N::translate('Select two records to merge.'); ?></p>

        <div class="form-group">
            <div class="control-label col-sm-3">
                <label for="gid1">
                    <?php echo /* I18N: Record is an indvidual, source, etc. */
