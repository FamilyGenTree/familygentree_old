...
switch ($action) {
    ...
    case 'load_json':
        ...
        Auth::user()
            ->setPreference('admin_site_log_page_size', $length);
    ...
    ->addInlineJavascript('
		jQuery(".table-site-logs").dataTable( {
			...
			pageLength: ' . Auth::user()
                                ->getPreference('admin_site_log_page_size', 20) . '
		});
...
<form class="form" name="logs">
    ...
    <div class="row">
        <div class="form-group col-xs-6 col-sm-3">
            ...
            <div class="input-group date">
                <input type="text" autocomplete="off" class="form-control" id="from" name="from"
                       value="<?php echo Filter::escapeHtml($from); ?>" autocomplete="off">
        ...
        <div class="form-group col-xs-6 col-sm-3">
            ...
            <div class="input-group date">
                <input type="text" autocomplete="off" class="form-control" id="to" name="to"
                       value="<?php echo Filter::escapeHtml($to); ?>" autocomplete="off">
                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
            </div>
        </div>
        ...
        <div class="form-group col-xs-6 col-sm-2">
            ...
            <?php echo FunctionsEdit::i()->select_edit_control('type', array(
                ''       => '',
                'auth'   => 'auth',
                'config' => 'config',
                'debug'  => 'debug',
    ...
    <div class="row">
        <div class="form-group col-sm-4">
            ...
            <input class="form-control" type="text" id="text" name="text"
                   value="<?php echo Filter::escapeHtml($text); ?>">
        </div>
    ...
    <div class="row text-center">
        ...
        <button type="submit" class="btn btn-primary"
                onclick="if (confirm('<?php echo I18N::translate('Permanently delete these records?'); ?>')) {document.logs.action.value='delete'; return true;} else {return false;}" <?php echo $action === 'show'
            ? '' : 'disabled'; ?>>
