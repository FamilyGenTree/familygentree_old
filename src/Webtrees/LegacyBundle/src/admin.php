...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div class="panel <?php echo Auth::isAdmin() && $update_available ? 'panel-danger' : 'panel-primary'; ?>">
        <div class="panel-heading" role="tab" id="webtrees-version-heading">
            <h2 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#webtrees-version-panel" aria-expanded="true"
                   aria-controls="webtrees-version-panel">
                    <?php echo WT_WEBTREES, ' ', WT_VERSION; ?>
                </a>
            </h2>
        </div>
        <div id="webtrees-version-panel" class="panel-collapse collapse in" role="tabpanel"
             aria-labelledby="webtrees-version-heading">
            <div class="panel-body">
                <p>
                    <?php echo /* I18N: %s is a URL/link to the project website */
                    I18N::translate('Support and documentation can be found at %s.', '<a href="http://webtrees.net/">webtrees.net</a>'); ?>
                </p>
                <?php if (Auth::isAdmin()): ?>
                    <p>
                        ...
                        <?php elseif ($update_available): ?>
                            ...
                            <a href="admin_site_upgrade.php" class="error">
                                <?php echo /* I18N: %s is a version number */
                                I18N::translate('Upgrade to webtrees %s.', Filter::escapeHtml($latest_version)); ?>
                            </a>
                        <?php else: ?>
    ...
    <?php if (Auth::isAdmin()): ?>
        <div class="panel <?php echo $unapproved || $unverified ? 'panel-danger' : 'panel-primary'; ?>">
            <div class="panel-heading" role="tab" id="users-heading">
                <h2 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#users-panel" aria-expanded="false"
    ...
    <div class="panel <?php echo array_sum($changes) ? 'panel-danger' : 'panel-primary'; ?>">
        <div class="panel-heading" role="tab" id="trees-heading">
            <h2 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#trees-panel" aria-expanded="false"
                        ...
                        <tr class="<?php echo $changes[$tree->getTreeId()] ? 'danger' : ''; ?>">
                            ...
                            <td class="text-right flip">
                                <?php if ($changes[$tree->getTreeId()]): ?>
                                    <a onclick="window.open('edit_changes.php', '_blank', chan_window_specs); return false;"
                                       href="#">
                                        <?php echo I18N::number($changes[$tree->getTreeId()]); ?>
                                        <span
                                            class="sr-only"><?php echo I18N::translate('Pending changes'); ?> <?php echo $tree->getTitleHtml(); ?></span>
                                    </a>
                                <?php else: ?>
                                    -
                                <?php endif; ?>
                            ...
                            <td class="text-right flip">
                                <?php if ($individuals[$tree->getTreeId()]): ?>
                                    <a href="indilist.php?ged=<?php echo $tree->getNameUrl(); ?>">
                                        ...
                                        <span
                                            class="sr-only"><?php echo I18N::translate('Individuals'); ?> <?php echo $tree->getTitleHtml(); ?></span>
                                    </a>
                                <?php else: ?>
                                    -
                                <?php endif; ?>
                            ...
                            <td class="text-right flip">
                                <?php if ($families[$tree->getTreeId()]): ?>
                                    <a href="famlist.php?ged=<?php echo $tree->getNameUrl(); ?>">
                                        ...
                                        <span
                                            class="sr-only"><?php echo I18N::translate('Families'); ?> <?php echo $tree->getTitleHtml(); ?></span>
                                    </a>
                                <?php else: ?>
                                    -
                                <?php endif; ?>
                            ...
                            <td class="text-right flip">
                                <?php if ($sources[$tree->getTreeId()]): ?>
                                    <a href="sourlist.php?ged=<?php echo $tree->getNameUrl(); ?>">
                                        ...
                                        <span
                                            class="sr-only"><?php echo I18N::translate('Sources'); ?> <?php echo $tree->getTitleHtml(); ?></span>
                                    </a>
                                <?php else: ?>
                                    -
                                <?php endif; ?>
                            ...
                            <td class="text-right flip">
                                <?php if ($repositories[$tree->getTreeId()]): ?>
                                    <a href="repolist.php?ged=<?php echo $tree->getNameUrl(); ?>">
                                        ...
                                        <span
                                            class="sr-only"><?php echo I18N::translate('Repositories'); ?> <?php echo $tree->getTitleHtml(); ?></span>
                                    </a>
                                <?php else: ?>
                                    -
                                <?php endif; ?>
                            ...
                            <td class="text-right flip">
                                <?php if ($media[$tree->getTreeId()]): ?>
                                    <a href="medialist.php?ged=<?php echo $tree->getNameUrl(); ?>">
                                        ...
                                        <span
                                            class="sr-only"><?php echo I18N::translate('Media objects'); ?> <?php echo $tree->getTitleHtml(); ?></span>
                                    </a>
                                <?php else: ?>
                                    -
                                <?php endif; ?>
    ...
    <?php if (Auth::isAdmin() && $files_to_delete): ?>
        <div class="panel panel-danger">
            <div class="panel-heading" role="tab" id="old-files-heading">
                <h2 class="panel-title">
                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#old-files-panel"
                       aria-expanded="false" aria-controls="old-files-panel">
                        <?php echo I18N::translate('Old files found'); ?>
                    </a>
                </h2>
            </div>
            <div id="old-files-panel" class="panel-collapse collapse" role="tabpanel"
                 aria-labelledby="old-files-heading">
                <div class="panel-body">
                    <p>
