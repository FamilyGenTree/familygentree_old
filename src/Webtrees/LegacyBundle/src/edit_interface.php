...
$controller
	...
	var locale_date_format="' . preg_replace('/[^DMY]/', '', str_replace(array(
                                                                                                        ...
                                                                                                        'D',
                                                                                                        'M'
                                                                                                    ), strtoupper(Globals::i()->DATE_FORMAT))) . '";
');
                    ...
                    <?php foreach ($record->getFacts() as $fact) { ?>
                        <?php if (!$fact->isPendingDeletion()) { ?>
                            <li>
                                ...
                                <textarea name="fact[]" dir="ltr"
                                          rows="<?php echo preg_match_all('/\n/', $fact->getGedcom(), $dummy_parameter_for_php53); ?>"
                                          style="width:100%;"><?php echo Filter::escapeHtml($fact->getGedcom()); ?></textarea>
                            </li>
                        <?php } ?>
                    <?php } ?>
                    <li>
    ...
    case 'editrawfact':
        ...
        <div id="edit_interface-page">
            ...
            <form method="post" action="edit_interface.php">
                ...
                <?php echo Filter::getCsrf(); ?>
                <textarea name="gedcom" id="gedcom"
                          dir="ltr"><?php echo Filter::escapeHtml($edit_fact->getGedcom()); ?></textarea>
        ...
        <div id="edit_interface-page">
            ...
            <form method="post" action="edit_interface.php" onsubmit="return check_form(this);">
                ...
                <table class="facts_table">
                    ...
                    <tr>
                        <td class="descriptionbox wrap width25"><?php echo WT_Gedcom_Tag::getLabel('CALN'); ?></td>
...
////////////////////////////////////////////////////////////////////////////////
    case 'addmedia_links':
        ...
        <div id="edit_interface-page">
            ...
            <form method="post" action="edit_interface.php?xref=<?php echo $person->getXref(); ?>"
                  onsubmit="findindi()">
                <input type="hidden" name="ged" value="<?php echo Filter::escapeHtml(WT_GEDCOM); ?>">
                ...
                <ul id="reorder_media_list">
                    <?php foreach ($sort_obje as $n => $obje) { ?>
                        <li class="facts_value" style="list-style:none;cursor:move;margin-bottom:2px;"
                            ...
                            <input type="hidden" name="order1[<?php echo $obje->getXref(); ?>]"
                                   value="<?php echo $n; ?>">
                        </li>
                    <?php } ?>
                </ul>
                ...
                <ul id="reorder_list">
                    ...
                    <p id="save-cancel">
                        ...
                        <input type="submit" class="save"
                               ...
                               value="<?php echo I18N::translate('sort by date of birth'); ?>">
                        <input type="button" class="cancel" value="<?php echo I18N::translate('close'); ?>"
                               onclick="window.close();">
                    </p>
            </form>
                ...
                <form name="changefamform" method="post" action="edit_interface.php">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="optionbox">
                                <a href="#" id="husbrem"
                                   style="display: <?php echo is_null($father) ? 'none' : 'block'; ?>;"
                            ...
                            <td class="optionbox">
                                <a href="#"
                                   onclick="return findIndi(document.changefamform.HUSB, document.getElementById('HUSBName'));">
                        ...
                        <tr>
                            ...
                            <td class="optionbox">
                                <a href="#" id="wiferem"
                                   style="display: <?php echo is_null($mother) ? 'none' : 'block'; ?>;"
                            ...
                            <td class="optionbox">
                                <a href="#"
                                   onclick="return findIndi(document.changefamform.WIFE, document.getElementById('WIFEName'));">
                                    <?php echo I18N::translate('Change'); ?>
                                </a>
                            </td>
                        </tr>
                        ...
                        foreach ($children as $child) { ?>
                            <tr>
                                <td class="descriptionbox">
                                    ...
                                    <input type="hidden" name="CHIL<?php echo $i; ?>"
                                           value="<?php echo $child->getXref(); ?>">
                                </td>
                                <td id="CHILName<?php echo $i; ?>"
                                    class="optionbox"><?php echo $child->getFullName(); ?>
                                </td>
                                <td class="optionbox">
                                    <a href="#" id="childrem<?php echo $i; ?>" style="display: block;"
                                       onclick="document.changefamform.CHIL<?php echo $i; ?>.value=''; document.getElementById('CHILName<?php echo $i; ?>').innerHTML=''; this.style.display='none'; return false;">
                                        <?php echo I18N::translate('Remove'); ?>
                                    </a>
                                </td>
                                <td class="optionbox">
                                    <a href="#"
                                       onclick="return findIndi(document.changefamform.CHIL<?php echo $i; ?>, document.getElementById('CHILName<?php echo $i; ?>'));">
                                        <?php echo I18N::translate('Change'); ?>
                                    </a>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="optionbox child">
                                <a href="#" id="childrem<?php echo $i; ?>" style="display: none;"
                                   onclick="document.changefamform.CHIL<?php echo $i; ?>.value=''; document.getElementById('CHILName<?php echo $i; ?>').innerHTML=''; this.style.display='none'; return false;">
                                    <?php echo I18N::translate('Remove'); ?>
                                </a>
                                <a href="#"
                                   onclick="remElement = document.getElementById('childrem<?php echo $i; ?>'); return findIndi(document.changefamform.CHIL<?php echo $i; ?>, document.getElementById('CHILName<?php echo $i; ?>'));">
            ...
            <form name="reorder_form" method="post" action="edit_interface.php">
                ...
                <ul id="reorder_list">
                    <?php foreach ($fams as $n => $family) { ?>
                        <li class="facts_value" style="cursor:move;margin-bottom:2px;"
                            id="li_<?php echo $family->getXref(); ?>">
                            <div class="name2"><?php echo $family->getFullName(); ?></div>
                            <?php echo $family->format_first_major_fact(WT_EVENTS_MARR, 2); ?>
                            <input type="hidden" name="order[<?php echo $family->getXref(); ?>]"
                                   value="<?php echo $n; ?>">
                        </li>
                    <?php } ?>
                </ul>
                <p id="save-cancel">
                    ...
                    <input type="submit" class="save"
                           ...
                           value="<?php echo I18N::translate('sort by date of marriage'); ?>">
                    <input type="button" class="cancel" value="<?php echo I18N::translate('close'); ?>"
                           onclick="window.close();">
                </p>
            </form>
...
function print_indi_form($nextaction, Individual $person = null, Family $family = null, Fact $name_fact = null, $famtag = 'CHIL', $gender = 'U')
{
    ...
    if (!$namerec) {
        ...
        if ($family) {
            ...
            if ($father && $father->getFirstFact('NAME')) {
                $father_name = $father->getFirstFact('NAME')
                                      ->getValue();
            } else {
                $father_name = '';
            }
            ...
            if ($mother && $mother->getFirstFact('NAME')) {
                $mother_name = $mother->getFirstFact('NAME')
                                      ->getValue();
            } else {
                $mother_name = '';
            }
        ...
        if ($person && $person->getFirstFact('NAME')) {
            $indi_name = $person->getFirstFact('NAME')
                                ->getValue();
        } else {
            $indi_name = '';
        }
    ...
    echo '<input type="submit" class="save" value="', /* I18N: button label */
    I18N::translate('save'), '">';
    if (preg_match('/^add_(child|spouse|parent|unlinked_indi)/', $nextaction)) {
        echo '<input type="submit" class="save" value="', /* I18N: button label */
        I18N::translate('go to new individual'), '" onclick="document.addchildform.goto.value=\'new\';">';
    }
    echo '<input type="button" class="cancel" value="', /* I18N: button label */
    I18N::translate('close'), '" onclick="window.close();">';
    echo '</p>';
    echo '</form>';
