...
if (!$ajax) {
    ...
    if ($tab == 0) {
        ...
        <?php
        echo '<div id="own-stats"><form method="post" id="own-stats-form" name="form" action="statisticsplot.php" onsubmit="statsModalDialog(\'statisticsplot.php?action=newform\', \'', I18N::translate('Statistics plot'), '\'); return false;">';
        ...
        if (isset(Application::i()->getSession()->statTicks[Globals::i()->WT_TREE->getTreeId()])) {
            $x_axis_boundary_ages    = Application::i()->getSession()->statTicks[Globals::i()->WT_TREE->getTreeId()]['x_axis_boundary_ages'];
            $x_axis_boundary_months  = Application::i()->getSession()->statTicks[Globals::i()->WT_TREE->getTreeId()]['x_axis_boundary_months'];
            $x_axis_boundary_numbers = Application::i()->getSession()->statTicks[Globals::i()->WT_TREE->getTreeId()]['x_axis_boundary_numbers'];
            $x_axis_boundary_periods = Application::i()->getSession()->statTicks[Globals::i()->WT_TREE->getTreeId()]['z_axis_boundary_periods'];
        } else {
        ...
        if (isset(Application::i()->getSession()->statTicks1[Globals::i()->WT_TREE->getTreeId()])) {
            $chart_shows = Application::i()->getSession()->statTicks1[Globals::i()->WT_TREE->getTreeId()]['chart_shows'];
            $chart_type  = Application::i()->getSession()->statTicks1[Globals::i()->WT_TREE->getTreeId()]['chart_type'];
            $surname     = Application::i()->getSession()->statTicks1[Globals::i()->WT_TREE->getTreeId()]['surname'];
        } else {
            $chart_shows = 'world';
