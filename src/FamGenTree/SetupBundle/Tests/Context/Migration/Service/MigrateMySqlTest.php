...
namespace FamGenTree\SetupBundle\Tests\Context\Migration\Service;
...
use FamGenTree\SetupBundle\Context\Migration\Service\Migrate;
use FamGenTree\SetupBundle\Context\Setup\Config\ConfigDatabase;
use FamGenTree\SetupBundle\Tests\Context\Migration\Service\Step\Migration\Migration20150401_0000b_Test;
use FamGenTree\SetupBundle\Tests\Context\Migration\Service\Step\WtMigration\MigrateWt1_6_2to20150401_0000b_Test;
use FamGenTree\SetupBundle\Tests\DatabaseTestCase;

/**
 * Class MigrateMySqlTest
 *
 * @package FamGenTree\SetupBundle\Tests\Context\Migration\Service
...
class MigrateMySqlTest extends DatabaseTestCase
{
     ...
     * @param ConfigDatabase $fixtureConfig
     *
     * @return \FamGenTree\SetupBundle\Context\Migration\Service\Migrate
     */
    protected function getMigrationMock(ConfigDatabase $fixtureConfig)
    {
        /** @var Migrate $mock */
        $mock = $this->getMockBuilder('FamGenTree\SetupBundle\Context\Migration\Service\Migrate')
    ...
    private function assertPlanEquals($expectedPlan, $actual)
    {
        if (null === $expectedPlan) {
            ...
            $this->assertInstanceOf('\FamGenTree\SetupBundle\Context\Migration\Plan\MigrationPlan', $actual);
