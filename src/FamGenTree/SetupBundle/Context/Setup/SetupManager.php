...
namespace FamGenTree\SetupBundle\Context\Setup;

use FamGenTree\SetupBundle\Context\Setup\Config\SetupConfig;
use FamGenTree\SetupBundle\Context\Setup\Exception\SetUpException;
use FamGenTree\SetupBundle\Context\Setup\Step\FirstSettingsStep;
 ...
 * Class SetupManager
 *
 * @package FamGenTree\SetupBundle\Context\Setup
...
class SetupManager
{
    ...
    /**
     * @return \FamGenTree\SetupBundle\Context\Setup\Step\DatabaseSettingsStep
     */
     ...
     *
     * @return \FamGenTree\SetupBundle\Context\Setup\Config\SetupConfig
     */
