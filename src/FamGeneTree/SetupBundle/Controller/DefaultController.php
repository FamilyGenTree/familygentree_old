...
use FamGeneTree\SetupBundle\Context\Setup\Service\PreRequirementCheck\CheckInterface;
use FamGeneTree\SetupBundle\Context\Setup\Service\PreRequirementsFactory;
use Fgt\Config;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\Intl\Intl;
use Webtrees\LegacyBundle\Legacy\FunctionsEdit;
...
class DefaultController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('fgt_setup_step1'));
        }
