...
if (count($controller->people) > 0) {
	...
	<div id="timeline_chart">
		...
		<div id="line" style="position:absolute; <?php echo Globals::i()->TEXT_DIRECTION == "ltr" ? "left: " . ($basexoffset + 22) : "right: " . ($basexoffset + 22); ?>px; top: <?php echo $baseyoffset; ?>px;">
		...
		<div id="scale<?php echo $controller->baseyear; ?>" style="position:absolute; <?php echo (Globals::i()->TEXT_DIRECTION == "ltr" ? "left: $basexoffset" : "right: $basexoffset"); ?>px; top: <?php echo ($baseyoffset - 5); ?>px; font-size: 7pt; text-align: <?php echo (Globals::i()->TEXT_DIRECTION == "ltr" ? "left" : "right"); ?>;">
		...
		for ($i = $controller->baseyear + 1; $i < $controller->topyear; $i++) {
			if ($i % $mod == 0) {
				echo "<div id=\"scale$i\" style=\"position:absolute; " . (Globals::i()->TEXT_DIRECTION == "ltr" ? "left: $basexoffset" : "right: $basexoffset") . "px; top:" . ($baseyoffset + (($i - $controller->baseyear) * $controller->scale) - $controller->scale / 2) . "px; font-size: 7pt; text-align:" . (Globals::i()->TEXT_DIRECTION === "ltr" ? "left" : "right") . ";\">";
				echo $i . '—';
				echo '</div>';
			}
		}
		echo "<div id=\"scale{$controller->topyear}\" style=\"position:absolute; " . (Globals::i()->TEXT_DIRECTION == "ltr" ? "left: $basexoffset" : "right: $basexoffset") . "px; top:" . ($baseyoffset + (($controller->topyear - $controller->baseyear) * $controller->scale)) . "px; font-size: 7pt; text-align:" . (Globals::i()->TEXT_DIRECTION == "ltr" ? "left" : "right") . ";\">";
		...
		foreach ($controller->people as $p => $indi) {
			...
			$col        = $p % 6;
			?>
			<div id="agebox<?php echo $p; ?>" style="cursor:move; position:absolute; <?php echo (Globals::i()->TEXT_DIRECTION == "ltr" ? "left: " . ($basexoffset + 20) : "right: " . ($basexoffset + 20)); ?>px; top:<?php echo $ageyoffset; ?>px; height:<?php echo $controller->bheight; ?>px; display:none;" onmousedown="ageCursorMouseDown(this, <?php echo $p; ?>);">
